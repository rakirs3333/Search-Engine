...
class basebrawler(scrapy.Spider):
    name = "basebrawlbot"
    start_urls = []
    ...
    def __init__(self):
        ...
        for i in range(start,end+1):
            self.start_urls.append(f'https://caasports.com/services/archives.ashx/stories?index={i}&page_size=1&sport=baseball&school=0&season=0&search=')
        super(basebrawler, self).__init__() 
