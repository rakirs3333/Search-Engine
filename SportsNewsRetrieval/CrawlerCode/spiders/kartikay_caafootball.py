...
class footbawler(scrapy.Spider):
    name = "sokka"
    start_urls = []
    ...
    def __init__(self):
        ...
        for i in range(start,end+1):
            self.start_urls.append(f'https://caasports.com/services/archives.ashx/stories?index={i}&page_size=1&sport=football&school=0&season=0&search=')
        super(footbawler, self).__init__() 
